...
\add_action('init', 'statik_register_people_tags_taxonomy', 1);

if (false === \function_exists('statik_register_people_tags_taxonomy')) {
    /**
     * Register Tags taxonomy for People.
     *
     * @since 2.0.0
     */
    function statik_register_people_tags_taxonomy(): void
    {
        $labels = [
        ...
        \register_taxonomy(
            ...
            [
                ...
                'graphql_single_name' => 'peopleTag',
                'graphql_plural_name' => 'peopleTags',
            ]
        );
    }
}
