...
\add_action('init', 'statik_register_people_categories_taxonomy', 1);

if (false === \function_exists('statik_register_people_categories_taxonomy')) {
    /**
     * Register categories taxonomy for People.
     *
     * @since 2.0.0
     */
    function statik_register_people_categories_taxonomy(): void
    {
        $labels = [
        ...
        \register_taxonomy(
            ...
            [
                ...
                'graphql_single_name' => 'peopleCategory',
                'graphql_plural_name' => 'peopleCategories',
            ]
        );
    }
}
