...
\add_action('init', 'statik_register_videos_tags_taxonomy', 1);

if (false === \function_exists('statik_register_videos_tags_taxonomy')) {
    /**
     * Register Tags taxonomy for Videos.
     *
     * @since 2.0.0
     */
    function statik_register_videos_tags_taxonomy(): void
    {
        $labels = [
        ...
        \register_taxonomy(
            ...
            [
                ...
                'show_in_rest' => true,
                'graphql_single_name' => 'videosTag',
                'graphql_plural_name' => 'videosTags',
            ]
        );
    }
}
