...
$inProgress = $deployment?->hasStatus(DeploymentInterface::IN_PROGRESS);
$ready = $deployment?->hasStatus(DeploymentInterface::READY);
...
<div class="wrapper">
    <main>
        ...
        <?php } ?>
        <?php if ($error) { ?>
            <h1><?= \__('Error', 'statik-deployment'); ?> <strong><?= $exception?->getCode() ?: 500; ?></strong></h1>
